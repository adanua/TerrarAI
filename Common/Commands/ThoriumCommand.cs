...
{
    internal class ThoriumCommand : ModCommand
    {
        public override string Command => "thorium";
        public override string Description =>
            "Get a quick response based off the Thorium Wiki on a query using AI.";
        public override string Usage => "/thorium <query>";
        ...
        public override async void Action(CommandCaller caller, string input, string[] args)
        {
            try
            {
                ...
                var MediaWikiClient = new ThoriumMediaWiki();
